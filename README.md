...
A full-stack customer intelligence workspace for executive KPIs, customer health, RFM segmentation, cohort retention, and churn prevention.

## Run locally

1. Install frontend packages: `npm install`
2. Install backend packages: `python -m pip install -r requirements.txt`
3. Start the API: `python backend/app.py`
